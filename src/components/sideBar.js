  ...
  return (
    <aside>
      <div id="menuContainer">
        <div id="logoArea">
          <svg id="logoIcon" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="react"
               className="svg-inline--fa fa-react fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 512 512">
